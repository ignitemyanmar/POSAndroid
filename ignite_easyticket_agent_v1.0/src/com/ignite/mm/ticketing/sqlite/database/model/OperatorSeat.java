...
public class OperatorSeat {
	...
	public String toString() {
		return "OperatorSeat [id=" + id + ", operator=" + operator
				+ ", operatorId=" + operatorId + ", fromName=" + fromName
				+ ", toName=" + toName + ", _class=" + _class
				+ ", availableDay=" + availableDay + ", price=" + price
				+ ", foreignPrice=" + foreignPrice + ", time=" + time
				+ ", departureTime=" + departureTime + ", tripdeparturetime="
				+ tripdeparturetime + ", minAvailabletime=" + minAvailabletime
				+ ", timeChecking=" + timeChecking + ", totalSeat=" + totalSeat
				+ ", permitseatTotal=" + permitseatTotal
				+ ", permitseatSoldtotal=" + permitseatSoldtotal
				+ ", timeUnit=" + timeUnit + ", availableSeats="
				+ availableSeats + ", totalPermitseats=" + totalPermitseats
				+ "]";
	}
