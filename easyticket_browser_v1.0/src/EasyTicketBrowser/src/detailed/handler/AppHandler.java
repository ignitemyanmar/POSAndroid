...
package EasyTicketBrowser.src.detailed.handler;
...
public class AppHandler extends CefAppHandlerAdapter {
  ...
  public void stateHasChanged(CefAppState state) {
    ...
    if (state == CefAppState.TERMINATED){
    	/*if (mBrowser != null) {
    		mBrowser.loadString("Hello", null);
		}else {
			System.out.println("Browser is null!");
		}*/
    	
    	//System.out.println("Terminate Occur...");
    	 System.exit(0);
    }
  }
  ...
  private String showErrorPage() {
  	// TODO Auto-generated method stub
        ...
        errorMsg_ += "<h1>Time Out!</h1>";
        errorMsg_ += "<p><br/><br/><br/></p>";
        errorMsg_ += "<h3>Fail to load ... :[ </h3>";
        errorMsg_ += "<p>Pls click <b>Reload</b> Button</p>";
