...
import EasyTicketBrowser.src.dialog.CookieManagerDialog;
import EasyTicketBrowser.src.dialog.DevToolsDialog;
...
import EasyTicketBrowser.src.dialog.UrlRequestDialog;
import EasyTicketBrowser.src.dialog.WebPluginManagerDialog;
    ...
    showForm.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        String form = "<html><head><title>RequestHandler test</title></head>";
               ...
               form+= "<p>See implementation of <u>RequestHandler.onBeforeBrowse(CefBrowser, CefRequest, boolean)</u> for details</p>";
               ...
               form+= "<p>See implementation of <u>RequestHandler.onBeforeResourceLoad(CefBrowser, CefRequest)</u> for details</p>";
               form+= "</form>";
               form+="</body></html>";
