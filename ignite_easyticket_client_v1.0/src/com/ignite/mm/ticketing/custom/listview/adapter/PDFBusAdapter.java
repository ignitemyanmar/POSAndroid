...
public class PDFBusAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.txt_user_name = (TextView)convertView.findViewById(R.id.txt_customer);
		...
		holder.txt_user_name.setText("Passenger : "+getItem(position).getUserName());
	...
	static class ViewHolder {
		...
		TextView txtDestination, txtOperatorName, txtSeatNo, txtTime, txtDate, txtprice, txtBusClass, txt_user_name;
	}
