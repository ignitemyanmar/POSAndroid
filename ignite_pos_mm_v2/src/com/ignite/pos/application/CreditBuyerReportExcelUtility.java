...
public class CreditBuyerReportExcelUtility {
  ...
  public CreditBuyerReportExcelUtility(List<Object> creditList, String filename, List<String> searchInfoList) {
  ...
  private void createLabel(WritableSheet sheet)
    ...
    //Write Title 
    addTitle(sheet, 0, 0, "Credit-Buyer Report");
    
    //Write Some Info
    addLabel(sheet, 0, 2, "Buyer Name: "+searchInfoList.get(0));
    ...
    addCaption(sheet, 2, 6, "Buyer Name");
  ...
  private void createContent(WritableSheet sheet) throws WriteException,
    ...
    for(Object creditObj: creditList){
    	...
    	Credit credit = (Credit) creditObj; 
    	
    	addLabel(sheet, 0, i, credit.getSalevoucher_id());
    	addLabel(sheet, 1, i, credit.getDate());
    	addLabel(sheet, 2, i, credit.getBuyer_name());
