...
import com.ignite.pos.application.SlowMovingReportExcelUtility;
...
public class SlowMovingReportActivity extends SherlockActivity{
	...
	private OnClickListener clickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			if (v == btn_print) {
				SaveFileDialog fileDialog = new SaveFileDialog(SlowMovingReportActivity.this);
	...
	public boolean checkFields() {
		if (editText_maxi_Qty.getText().toString().length() == 0) {
			editText_maxi_Qty.setError("Enter Unsold Qty");
			return false;
		}
