...
public class CreditBuyerReportAdapter extends BaseAdapter{

	private LayoutInflater mInflater;
	private List<Object> tempList;
	public CreditBuyerReportAdapter(Activity aty, List<Object> tempList) {
		super();
	...
	public Credit getItem(int arg0) {
		// TODO Auto-generated method stub
		return (Credit) tempList.get(arg0);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView =  mInflater.inflate(R.layout.list_item_credit_buyer_report, null);
	...
	static class ViewHolder {
		...
		TextView txt_buyer_name, txt_date, txt_vou_no, txt_credit_total, txt_credit_paid_amount, txt_credit_left_amount;
	}
