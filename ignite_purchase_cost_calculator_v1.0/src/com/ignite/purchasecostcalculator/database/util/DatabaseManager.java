...
public abstract class DatabaseManager{
	...
	protected String  DATABASE_FILE_PATH = Environment.getExternalStorageDirectory()+"/IgnitePCostCalculator/.database";	
	protected final String  DATABASE_NAME = "pcostcalculator_db.sqlite3";
