...
public class SaleReportExcelUtility {
  ...
  private void createLabel(WritableSheet sheet)
    ...
    addCaption(sheet, 2, 2, "Sale Person");
  ...
  private void createContent(WritableSheet sheet) throws WriteException,
    ...
    for(Object saleV: saleVoucherList){
    	...
    	addLabel(sheet, 0, i, sv.getVid());
    	addLabel(sheet, 1, i, sv.getVdate());
    	addLabel(sheet, 2, i, sv.getSalePerson());
    	addLabel(sheet, 3, i, sv.getTotal());
    	i++;
    }
  }
