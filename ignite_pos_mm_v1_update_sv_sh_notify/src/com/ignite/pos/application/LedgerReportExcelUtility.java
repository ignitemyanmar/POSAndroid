...
public class LedgerReportExcelUtility {
  ...
  private void createLabel(WritableSheet sheet)
    ...
    // Write a few headers
    addCaption(sheet, 0, 2, "Item Name");
    addCaption(sheet, 1, 2, "Date");
    addCaption(sheet, 2, 2, "Old Stock Qty");
    addCaption(sheet, 3, 2, "Purchase Qty");
    addCaption(sheet, 4, 2, "Sale Qty");
    addCaption(sheet, 5, 2, "Return Qty");
    addCaption(sheet, 6, 2, "New Stock Qty");
