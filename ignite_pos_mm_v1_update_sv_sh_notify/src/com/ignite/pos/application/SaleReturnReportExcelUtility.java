...
public class SaleReturnReportExcelUtility {
  ...
  private void createLabel(WritableSheet sheet)
    ...
    // Write a few headers
    addCaption(sheet, 0, 2, "Return Voucher");
    addCaption(sheet, 1, 2, "Return Date");
    addCaption(sheet, 2, 2, "Item Code");
    addCaption(sheet, 3, 2, "Item Name");
    addCaption(sheet, 4, 2, "Old Sale Qty");
    addCaption(sheet, 5, 2, "Return Qty");
    addCaption(sheet, 6, 2, "Refund Price");
    addCaption(sheet, 7, 2, "Refund Amount");
