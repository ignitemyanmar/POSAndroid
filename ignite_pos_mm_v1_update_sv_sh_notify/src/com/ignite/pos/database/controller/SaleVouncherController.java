...
public class SaleVouncherController extends DatabaseManager{
	...
	private static final String[] FIELD_NAME = {"vid","cusname","itemid","itemname","qty","price","itemtotal","vdate","total","salePerson","updatePerson","discount","updateDate","marginalPrice","returnableQty","updated"};
