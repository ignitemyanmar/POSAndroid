...
public class AddBarcodeActivity extends SherlockActivity{
	...
	private void saveData()
	{
		...
		if(itemList != null && itemList.size() > 0){
			...
			txt_last_item_code.setText("ေနာက္ဆံုးကုတ္နံပါတ္ ["+((ItemList)itemList.get(0)).getItemId()+"]");
		}
	...
	private void getCategory()
	{
		...
		catList.add(new Category(0, "အမ်ိဳးအစားေရြးပါ"));
	...
	private void getSubCategory()
	{
		...
		subcatList.add(new SubCategory(0, "အမ်ိဳးအစားခြဲ ေရြးပါ", 0));
	...
	private void getBrand()
	{
		...
		brandList.add(new Brand(0, "တံဆိပ္ေရြးပါ"));
