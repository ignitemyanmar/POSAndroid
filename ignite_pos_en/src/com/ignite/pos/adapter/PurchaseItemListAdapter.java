...
public class PurchaseItemListAdapter extends BaseAdapter{
	private List<PurchaseVoucher> listObj;
	...
	public PurchaseItemListAdapter(Activity aty, List<PurchaseVoucher> cart_Item_List) {
		super();
	...
	public PurchaseVoucher getItem(int position) {
		// TODO Auto-generated method stub
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.price.setText(getItem(position).getPurchasePrice());
